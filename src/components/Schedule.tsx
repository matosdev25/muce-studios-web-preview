...
export function Schedule() {
  ...
  return (
    <section id="agenda" className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute -left-40 top-1/3 size-80 bg-muce/20 blur-3xl rounded-full" aria-hidden />

      <div className="relative mx-auto max-w-6xl px-6 grid lg:grid-cols-[1fr_2fr] gap-12">
        {/* Left intro */}
        <motion.div
        ...
        >
          ...
          <div className="mt-8 rounded-xl border border-line bg-surface/60 backdrop-blur p-5">
          ...
          <div className="relative mt-8 aspect-[16/10] rounded-2xl overflow-hidden border border-line bg-surface">
        ...
        >
          {/* Step 1 — Brand */}
          <div
            className={`rounded-2xl border bg-surface/60 backdrop-blur p-6 transition-colors ${
            ...
            <div className="mt-5 space-y-4">
              <Field label="Nombre completo">
                <input
                  ...
                  className="w-full rounded-lg bg-bg/80 border border-line px-3 py-2.5 text-sm placeholder:text-text-dim focus:border-muce focus:outline-none focus:ring-2 focus:ring-muce/30 transition"
                />
              </Field>
              ...
              <Field label="Servicio de interés">
                <select
                  ...
                  className="w-full rounded-lg bg-bg/80 border border-line px-3 py-2.5 text-sm focus:border-muce focus:outline-none focus:ring-2 focus:ring-muce/30 transition"
                >
              ...
              <Field label="Objetivo / contexto">
                <textarea
                  ...
                  className="w-full rounded-lg bg-bg/80 border border-line px-3 py-2.5 text-sm placeholder:text-text-dim focus:border-muce focus:outline-none focus:ring-2 focus:ring-muce/30 transition resize-none"
                />
              </Field>
              ...
              <button
                ...
                onClick={() => setStep(2)}
                className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-muce hover:bg-muce-bright disabled:bg-surface-2 disabled:text-text-dim disabled:cursor-not-allowed text-white font-medium py-3 transition-colors shadow-glow disabled:shadow-none"
              >
                Continuar
            ...
            <div className="mt-5">
              ...
              {step === 1 ? (
                ...
                <motion.button
                  ...
                  className="mt-5 w-full inline-flex items-center justify-center gap-2 rounded-lg bg-muce hover:bg-muce-bright text-white font-medium py-3 transition-colors shadow-glow"
                >
                  Confirmar reunión
